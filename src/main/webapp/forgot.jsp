			...
			<div class="col-md-4" id="form">
				<form action="ForgotController" method="post">
					...
					<div class="form-group">
						<input type="email" placeholder="Email" name="email" class="form-control"value="${email}" hidden="true">
					</div>
						<div class="form-group">
						<input type="email" placeholder="Email" name="email" class="form-control"value="${email}" disabled>
					</div>
					<div class="form-group">
